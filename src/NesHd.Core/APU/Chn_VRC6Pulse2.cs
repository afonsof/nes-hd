...
namespace NesHd.Core.APU
{
    public class Chn_VRC6Pulse2
    {
        ...
        {
            st.VRC6Pulse2_Volume = this._Volume;
            st.VRC6Pulse2DutyPercentage = this.DutyPercentage;
            st.VRC6Pulse2_DutyCycle = this._DutyCycle;
            st.VRC6Pulse2_FreqTimer = this._FreqTimer;
            st.VRC6Pulse2_Enabled = this._Enabled;
            st.VRC6Pulse2_Frequency = this._Frequency;
            st.VRC6Pulse2_SampleCount = this._SampleCount;
            st.VRC6Pulse2_RenderedLength = this._RenderedLength;
            st.VRC6Pulse2WaveStatus = this.WaveStatus;
            st.VRC6Pulse2OUT = this.OUT;
        }
        public void LoadState(StateHolder st)
        {
            this._Volume = st.VRC6Pulse2_Volume;
            this.DutyPercentage = st.VRC6Pulse2DutyPercentage;
            this._DutyCycle = st.VRC6Pulse2_DutyCycle;
            this._FreqTimer = st.VRC6Pulse2_FreqTimer;
            this._Enabled = st.VRC6Pulse2_Enabled;
            this._Frequency = st.VRC6Pulse2_Frequency;
            this._SampleCount = st.VRC6Pulse2_SampleCount;
            this._RenderedLength = st.VRC6Pulse2_RenderedLength;
            this.WaveStatus = st.VRC6Pulse2WaveStatus;
            this.OUT = st.VRC6Pulse2OUT;
        }
    }
}
